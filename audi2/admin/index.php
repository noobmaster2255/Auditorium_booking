...
<head>
	<title>ONLINE AUDITORIUM BOOKING WEBSITE</title>
	<!-- Meta-Tags -->
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item text-center" href="viewcustomer.php">Customer Info</a>
								<a class="dropdown-item text-center" href="approve.php">Approved Owners</a>
								<a class="dropdown-item text-center" href="viewowner_reg.php">Owners</a>
							</div>
							</li>
						<li class="nav-item">
							<a class="nav-link" href="viewauditorium.php">VIEW AUDITORIUMS</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="viewbooking.php">VIEW BOOKINGS</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="viewfeedback.php">VIEW FEEDBACKS</a>
						</li>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
							    aria-expanded="false">
