...
if(isset($_GET['mode']))
{
 ...
 if($m=="ac")
{
		$sql="select * from add_auditorium where category='$m'";
...
<?php
	echo "<center><font color='black'><h3>".$tbl[$i][1]."</h3></font></center>
	&emsp;&emsp;&emsp;&emsp;<center><font color='green'>Location:</font>".$tbl[$i][2]."</center>
	
&emsp;&emsp;&emsp;&emsp;<center><font color='green'>Amount:</font>".$tbl[$i][6]."</center>";
	?>
