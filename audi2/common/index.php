...
<body>
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item text-center" href="customer.php">Customer</a>
								<a class="dropdown-item text-center" href="owner.php">Owner</a>
							</div>
						</li>
						<li class="nav-item">
	...
	<section class="reviews_sec py-5">
		<div class="container py-xl-5 py-sm-3">
			<h5 class="main-w3l-title mb-sm-3 mb-2">Events Memory</h5>
			<div class="inner-sec-w3layouts-agileinfo">
				<section class="slider">
					<div class="flexslider">
						<ul class="slides">
